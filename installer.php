...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220530_ajked_5592513ee98118a78671_20220622061441_archive.zip';
	const ARCHIVE_SIZE		 = '63172803';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5592513-22061441';
    const SECONDARY_PACKAGE_HASH = 'a693b03-22061441';
	const VERSION			 = '1.4.6';
